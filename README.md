...
This server exposes an API that is used by the web UI, exposing these actions and some other related information. The API itself is GraphQL, see [`src/httptoolkit-server.ts`](src/httptoolkit-server.ts) for the full details.
